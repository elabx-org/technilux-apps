#!/bin/bash
# Build script for Advanced Forwarding Plus
...
echo "=== Advanced Forwarding Plus Build Script ==="
echo ""
...
echo ""
echo "Building Advanced Forwarding Plus..."

# Build
dotnet build -c Release AdvancedForwardingPlus.csproj

# Copy dnsApp.config to output
cp dnsApp.config bin/Release/net9.0/
...
echo ""
echo "Output files:"
echo "  bin/Release/net9.0/AdvancedForwardingPlus.dll"
echo "  bin/Release/net9.0/dnsApp.config"
echo "  AdvancedForwardingPlus.zip (ready for distribution)"
echo ""
echo "To install:"
echo "  1. Via Technitium GUI: Apps > Install > Upload AdvancedForwardingPlus.zip"
echo "  2. Manual: Copy DLL to /etc/dns/apps/AdvancedForwardingPlus/"
echo ""
